...
wetsRoads1pem<-st_read(file.path(spatialOutDir,"wetsRoads1pem.gpkg"))

#wetsRoads1C<-wetsRoads1 %>% st_drop_geometry()

wetsRoadspem<-wetsRoads1pem %>%
  st_drop_geometry() %>%
